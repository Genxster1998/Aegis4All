...
package com.mokke.aegis.activities;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public class SettingsFragment extends PreferenceFragment implements
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mForceStopPreference.setChecked(Settings.System.getInt(getContentResolver(), KEY_AEGIS_WARDEN_FORCE_STOP, 0) != 0);
        }
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (KEY_AEGIS_WARDEN_FORCE_STOP.equals(key)) {
                ...
                Settings.System.putInt(getContentResolver(), KEY_AEGIS_WARDEN_FORCE_STOP, value ? 1 : 0);
            }
            return true;
        }
    }
